    ...
    experiences: [
      {
        ...
        achievements: [
          <>
            RustSDK Bazel 改造：将 PB 生成流程从 Cargo 迁至
            Bazel，实现产物缓存；pb 增量构建提速 61.7%，二次构建缓存提速 94.9%。
          </>,
          <>
            Monorepo 迁移：主导 Android 端 CI
            迁移，开发路径重定向插件降低适配成本；完成 80% 的 47
            个任务并清理无用任务。
          </>,
          <>
            iOS 客户端构建优化：通过移除冗余 public import，优化 16
            个模块，提升整体构建速度
          </>,
        ],
        images: [
